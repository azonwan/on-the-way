...
useAu=false;useSb=false;selfPallet=true;palletWidth=300;palletHeight=160;PalletURL='./js/pc_emoji_palet/pc_emoji_palet.html';var palletList={docomo:{id:"epDocomo",emoji:[{start:1,end:60}],shortname:"i"},au:{id:"epAu",emoji:[{start:1,end:10}],shortname:"e"},softbank:{id:"epSb",emoji:[{start:1,end:24}],shortname:"s"}};function createEmojiPalletDoCoMo()
...
function output(){document.write('<div id="emoji_pallet" class="padding_ss" style="width:439px;">');if(selfPallet){document.write('图标');document.write('<a href="#" onclick=\'togglePallet("epDocomo"); return false;\'>DoCoMo</a>');if(useAu)document.write('　<a href="#" onclick=\'togglePallet("epAu"); return false;\'>AU</a>');if(useSb)document.write('　<a href="#" onclick=\'togglePallet("epSb"); return false;\'>SoftBank</a>');createEmojiPalletDoCoMo();if(useAu){createEmojiPalletAu();}
if(useSb){createEmojiPalletSoftBank();}}else{document.write('<a href="javascript:popupPallet(PalletURL)">图标</a>');}
document.write('</div>');}
