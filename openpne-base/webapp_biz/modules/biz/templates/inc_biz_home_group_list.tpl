...
<div class="partsHeading"><h3>参与团体列表</h3></div>
...
<ul class="moreInfo">
<li><a href="({t_url m=biz a=page_fh_group_list})&amp;target_c_member_id=({$c_member_id})">查看所有(({$group_count}))</a></li>
<li><a href="({t_url m=biz a=page_h_biz_group_add})">创建团队</a></li>
<li><a href="({t_url m=biz a=page_h_biz_group_find_all})">团队检索</a></li>
</ul>
</div>
</div>
({* }}} *})
