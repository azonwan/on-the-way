...
<div class="partsHeading"><h3>Todo（目标计划工具）</h3></div>
...
<label for="is_all">共同Todo</label><input type="checkbox" class="input_checkbox" name="is_all" id="is_all" value="1" />
...
({/strip})</td>
<td class="operation">
<a href="({t_url m=biz a=page_fh_home_edit_biz_todo})&amp;id=({$value.biz_todo_id})&amp;target_id=({$target_id})"><img src="./skin/default/img/biz/edit_2.gif" alt="编辑" /></a>
<a href="({t_url m=biz a=do_`$cmd`_home_delete_biz_todo})&amp;sessid=({$PHPSESSID})&amp;delid=({$value.biz_todo_id})&amp;target_id=({$target_id})"><img src="./skin/default/img/biz/delete_2.gif" alt="删除" /></a>
</td>
</tr>
({/if})
({/foreach})
