...
<div class="partsHeading"><h3>团队列表</h3></div>
...
({if $pager.prev_page})<p class="prev"><a href="({t_url m=biz a=page_fh_group_list})&amp;page=({$pager.prev_page})&amp;target_c_member_id=({$target_member.c_member_id})">上一页</a></p>({/if})
<p class="number">({$pager.start_num})条～({$pager.end_num})条 记录</p>
({if $pager.next_page})<p class="next"><a href="({t_url m=biz a=page_fh_group_list})&amp;page=({$pager.next_page})&amp;target_c_member_id=({$target_member.c_member_id})">下一页</a></p>({/if})
</div>
...
<div class="partsHeading"><h3>目录一览</h3></div>
<div class="block">
<p>没有参加的团体</p>
</div>
</div></div>
