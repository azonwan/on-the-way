...
INSERT IGNORE INTO `c_review_category` VALUES (NULL,'Watches','手表',13);
INSERT IGNORE INTO `c_review_category` VALUES (NULL,'Baby','妇婴',14);
INSERT IGNORE INTO `c_review_category` VALUES (NULL,'Apparel','服饰&鞋类',15);
...
INSERT INTO `c_config_decoration` VALUES (NULL,'op:b','强调','<strong>示例</strong>',1);
INSERT INTO `c_config_decoration` VALUES (NULL,'op:u','下划线','<ins>示例</ins>',1);
INSERT INTO `c_config_decoration` VALUES (NULL,'op:s','删除线','<del>示例</del>',1);
INSERT INTO `c_config_decoration` VALUES (NULL,'op:i','斜体','<em>示例</em>',1);
INSERT INTO `c_config_decoration` VALUES (NULL,'op:large','大字符,'<span style=\"font-size:20px;\">示例</span>',1);
INSERT INTO `c_config_decoration` VALUES (NULL,'op:small','小字符','<span style=\"font-size:8px;\">示例</span>',1);
INSERT INTO `c_config_decoration` VALUES (NULL,'op:color','设置文字颜色','<span style=\"color:#33F864;\">示例</span>',1);
