...
({assign var="page_name" value="节日设定"})
...
<td><span class="textBtnS"><input type="submit" value="　变　更　"></span></td>
</form>
<form action="./" method="post">
<td>
<input type="hidden" name="m" value="({$module_name})">
...
<input type="hidden" name="sessid" value="({$PHPSESSID})">
<input type="hidden" name="c_holiday_id" value="({$item.c_holiday_id})">
<span class="textBtnS"><input type="submit" class="submit" value="　删　除　"></span>
</td>
</form>
</tr>
({/foreach})
...
<td colspan="2"><span class="textBtnS"><input type="submit" value="　添加节日　"></span></td>
</form>
</tr>
</tbody>
</table>
