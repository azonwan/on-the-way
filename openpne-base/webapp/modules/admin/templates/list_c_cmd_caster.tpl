...
({assign var="page_name" value="CMD变换设定"})
...
<h2>({$page_name})</h2>
<p>*这里需要直接在目录public_html/cmd/ 下添加新的JS即可在后台见到新的CMD设定选项。</p>
<div class="contents">
...
<td>
<span class="textBtnS"><input type="submit" class="submit" value="　变  更　" /></span>
</td>
({/t_form_block})
<td>
({t_form_block m=$module_name})
