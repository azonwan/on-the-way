...
class pc_page_h_album_search extends OpenPNE_Action
{
    function execute($requests)
    {
        ...
        //検索する場合
    if ($keyword) {
                    $list_set=fp_h_album_list_all_search_c_album4c_album($keyword, $page_size, $page, $u);
            } else {
                
                        $list_set = p_fh_album_list_album_list_public4c_member_id($target_c_member_id, $page_size, $page, $u);
