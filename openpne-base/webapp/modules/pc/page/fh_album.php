...
class pc_page_fh_album extends OpenPNE_Action
{
    function execute($requests)
    {
        ...
        $comment_list = db_album_get_c_album_comment_list4c_album_id($target_c_album_id);
        $this->set('target_album_comment_list', $comment_list);
        $this->set('comment_num',count($comment_list));
        //アルバムに登録された写真
