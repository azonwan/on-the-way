...
({/if})
<!--视频标签开始-->
<a id="" href="#" onclick="window.open('({t_url m=pc a=page_h_video_insert_dialog})','','width=380,height=95,toolbar=no,scrollbars=yes,left=295,top=360')"><img src="({t_img_url_skin filename=deco_op_video})" alt="插入视频"/></a>
<!--视频标签结束-->

<!--图片标签开始-->
<a id="" href="#" onclick="window.open('({t_url m=pc a=page_h_img_insert_dialog})','','width=380,height=95,toolbar=no,scrollbars=yes,left=295,top=360')"><img src="({t_img_url_skin filename=deco_op_img})" alt="插入图片"/></a>
<!--图片标签结束-->
