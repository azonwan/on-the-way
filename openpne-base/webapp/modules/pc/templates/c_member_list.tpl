...
({if $is_prev})<p class="prev"><a href="({t_url m=pc a=page_c_member_list})&amp;page=({$page-1})&amp;target_c_commu_id=({$c_commu_id})">上一页</a></p>({/if})
<p class="number">({$start_num})条～({$end_num})条 记录</p>
({if $is_next})<p class="next"><a href="({t_url m=pc a=page_c_member_list})&amp;page=({$page+1})&amp;target_c_commu_id=({$c_commu_id})">下一页</a></p>({/if})
</div>
({/strip})({/capture})
