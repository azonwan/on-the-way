...
<div class="partsHeading"><h3>活动参加者一览</h3></div>
...
({if $is_prev})<p class="prev"><a href="({t_url m=pc a=page_c_event_member_list})&amp;page=({$page-1})&amp;target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">上一页</a></p>({/if})
<p class="number">({$start_num})条～({$end_num})条 记录</p>
({if $is_next})<p class="next"><a href="({t_url m=pc a=page_c_event_member_list})&amp;page=({$page+1})&amp;target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">下一页</a></p>({/if})
</div>
({/strip})({/capture})
...
<li><a href="({t_url m=pc a=page_c_event_detail})&amp;target_c_commu_topic_id=({$c_topic.c_commu_topic_id})">返回活动 [({$c_topic.name})] 页面</a></li>
</ul></div>
({* }}} *})
