...
({if $is_prev})<p class="prev"><a href="({t_url m=pc a=page_h_diary_list_friend})&amp;page=({$page-1})">上一页</a></p>({/if})
<p class="number">({$pager.start})条～({$pager.end})条 记录</p>
({if $is_next})<p class="next"><a href="({t_url m=pc a=page_h_diary_list_friend})&amp;page=({$page+1})">下一页</a></p>({/if})
</div>
({/strip})({/capture})
...
<div class="partsHeading"><h3>({$WORD_MY_FRIEND})最新({$WORD_DIARY})</h3></div>
<div class="block">
<p>没有({$WORD_MY_FRIEND})的({$WORD_DIARY})。</p>
</div>
</div></div>
({* }}} *})
({/if})
...
<div class="partsHeading"><h3>({$WORD_MY_FRIEND})最新博客</h3></div>
