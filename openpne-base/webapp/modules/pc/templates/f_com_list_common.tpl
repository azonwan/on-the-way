...
<div class="partsHeading"><h3>相同({$WORD_COMMUNITY})目录</h3></div>
...
({if $pager.prev_page})<p class="prev"><a href="({t_url m=pc a=page_f_com_list_common})&amp;page=({$pager.prev_page})&amp;target_c_member_id=({$target_member.c_member_id})">上一页</a></p>({/if})
<p class="number">({$pager.start_num})～({$pager.end_num})条</p>
({if $pager.next_page})<p class="next"><a href="({t_url m=pc a=page_f_com_list_common})&amp;page=({$pager.next_page})&amp;target_c_member_id=({$target_member.c_member_id})">下一页</a></p>({/if})
</div>
({/strip})({/capture})
...
<div class="partsHeading"><h3>相同({$WORD_COMMUNITY})一览</h3></div>
<div class="block">
<p>没有相同的({$WORD_COMMUNITY})。</p>
</div>
</div></div>
({* }}} *})
({/if})
