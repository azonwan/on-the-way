...
<div class="partsHeading"><h3>要删除下列投稿吗？</h3></div>
...
<tr><th>文件</th><td><a href="({t_url m=pc a=do_c_file_download})&amp;target_c_commu_topic_comment_id=({$c_commu_topic_comment.c_commu_topic_comment_id})&amp;sessid=({$PHPSESSID})">({$c_commu_topic_comment.original_filename})</a></td></tr>
({/if})
({/if})
</table>
