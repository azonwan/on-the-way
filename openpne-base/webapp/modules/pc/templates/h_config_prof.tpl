...
<div class="partsHeading"><h3>个人资料更改</h3><p>(<strong>※</strong>项必须填写)</p>({if $SSL_SELECT_URL})<p class="link"><a href="({$SSL_SELECT_URL})">({if $HTTPS})标准(http)({else})SSL(https)({/if})更多</a></p>({/if})</div>
