...
({if $is_prev})
<p class="prev"><a href="({t_url m=pc a=page_h_album_search})&amp;page=({$page-1})&amp;target_c_member_id=({$target_member.c_member_id})({if $url_keyword})&amp;keyword=({$url_keyword})({/if})">上一页</a></p>
({/if})
<p class="number">
...
({if $is_next})
<p class="next"><a href="({t_url m=pc a=page_h_album_search})&amp;page=({$page+1})&amp;target_c_member_id=({$target_member.c_member_id})({if $url_keyword})&amp;keyword=({$url_keyword})({/if})">下一页</a></p>
({/if})
</div>
({/strip})({/capture})
