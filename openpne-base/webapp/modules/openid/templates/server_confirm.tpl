...
<div class="partsHeading"><h3>OpenID登录确认</h3></div>
<div class="block">
<p>使用OpenID登录以下的网站。<br />
({$trust_root})</p>
<ul class="moreInfo button">
<li>
({t_form_block m=openid a=do_server_confirm})
<input type="submit" class="input_submit" value="　许可　" />
({/t_form_block})
</li>
<li>
({t_form_block _method=get m=pc})
<input type="submit" class="input_submit" value="　拒绝　" />
({/t_form_block})
</li>
</ul>
</div>
