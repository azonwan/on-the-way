...
function handle_kengen_error()
{
    ...
    case 'pc':
        ...
        break;
    case 'ktai':
        ktai_display_error('此页面无法访问。');
        break;
    default:
        openpne_display_error('此页面无法访问。');
        break;
    }
    exit;
}
